...
class VideoClip(Base):
    ...
    edit_suggestion: Mapped[str] = mapped_column(Text, default="")
    edit_reason: Mapped[str] = mapped_column(Text, default="")
    risk_level: Mapped[str] = mapped_column(String(40), default="unknown")
    export_status: Mapped[str] = mapped_column(String(40), default="not_started")
    clip_file_uri: Mapped[str | None] = mapped_column(String(500), nullable=True)
    ...
    @property
    def source_video_title(self) -> str:
